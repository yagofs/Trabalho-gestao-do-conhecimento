...
% ---
\titulo{Bases de Conhecimento na Gestão do Conhecimento: Fundamentação Teórica e Contextualização}
...
Instituto Federal de Educação, Ciência e Tecnologia de Goiás -- IFG
  ...
  Graduação em Gestão do Conhecimento}
...
\begin{fichacatalografica}
	...
	\hspace{0.5cm}
		...
		I. Instituto Federal de Educação, Ciência e Tecnologia de Goiás.
		II. Gestão do Conhecimento.
		III. Bases de Conhecimento na Gestão do Conhecimento: Fundamentação Teórica e Contextualização			
	\end{minipage}}
	\end{center}
\end{fichacatalografica}
% ---
...
% PARTE
% ----------------------------------------------------------
\part*{Histórico e Linha do Tempo das Bases de Conhecimento}
\include{docs/8_materials_methods}
% ---------------------------------------------------------% ----------------------------------------------------------
% PARTE
% ----------------------------------------------------------
\part*{Contextualização e Funcionamento}
